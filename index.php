    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="#myModal1" data-toggle="modal">Login/Register</a>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <h2 class="section-heading">The First Online Hearing Test Simulator</h2>
                    <hr class="light">
                    <p class="text-faded">This is a tool made to help Purdue Graduate Students in the Audiology department practice giving hearing tests to virtual patients. Our mission is to help students perfect their skills before performing tests on real patients. Teachers can also use this tool to assign homework and monitor student progress!</p>
                    <a href="#services" class="page-scroll btn btn-default btn-xl">Join for free today!</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <aside class="bg-dark">
        <div class="container text-center">
            <div class="call-to-action">
                <h2>Free Accounts Available Today</h2>
                <a href="templates/registration.html" class="btn btn-default btn-xl wow tada">Register Now!</a>
            </div>
        </div>
    </aside>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    ...
                    <hr class="primary">
                    <p>This website is part of a Purdue EPICS project. More details can be found if you vist the EPICS Wise team website.</p>
                </div>
                <div class="col-lg-4 col-lg-offset-2 text-center">
                    <i class="fa fa-phone fa-3x wow bounceIn"></i>
                    <p><a>765-496-1068</a></p>
                </div>
                <div class="col-lg-4 text-center">
                    <i class="fa fa-envelope-o fa-3x wow bounceIn" data-wow-delay=".1s"></i>
                    <p><a href="mailto:your-email@your-domain.com">epics-wise@purdue.edu</a></p>
                </div>
            </div>
        </div>
    </section>
