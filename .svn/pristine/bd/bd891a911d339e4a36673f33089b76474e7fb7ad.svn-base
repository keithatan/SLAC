...
{
	/// <summary>
	/// Summary description for AudiometerPanel.
	/// </summary>
	public class AudiometerPanel : System.Windows.Forms.Panel
	{
		/// <summary>
		...
		/// <summary>
		/// All the fields created on the AudiometerPanel form
		/// </summary>
		...
		/// <summary>
		/// AudiometerPanelControls is a structure designed to make keeping track of test parameters easier
		/// It also will be accessed by the mdi parent
		/// </summary>
		public struct AudiometerPanelSettings
		{
		...
		public AudiometerPanelSettings ameterSettings = new AudiometerPanelSettings();
        public channelSettings Channel1 = new channelSettings();
        public channelSettings Channel2 = new channelSettings();

		// delegates used for feedback to AudiometerPanel
		...
		/// <summary>
		/// The constructor of the AudiometerPanel class
		/// </summary>
		/// <param name="_presDel">The delegate function to be called when the presentation bar is pressed</param>
		/// <param name="_stChDel">The delegate function to be called when the AudiometerPanel state changes</param>
		public AudiometerPanel(presentationDelegate _presDel, stateChangedDelegate _stChDel)
		{
			//
            ...
            // to include default settings of AudiometerPanel used in audiology
            // clinic. Notebook page 12.

            // General AudiometerPanel default settings
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(AudiometerPanel));
            ...
            this.Name = "AudiometerPanel";
            //this.StartPosition = System.Windows.Forms.FormStartPosition.Manual;
            this.Text = "AudiometerPanel";
            //this.Load += new System.EventHandler(this.AudiometerPanel_Load);
...
private void label34_Click(object sender, EventArgs e)
{
 	throw new NotImplementedException();
		    ...
		    case TransducerType.Bone:
				switch (ameterSettings.frequency)
                {
                    ...
                    case 1000:
                        ...
                        else if (currVol > 75) // etc. See Max_AudiometerPanel_Output spreadsheet
                        {
                            currVol = 75;
                            return true;
                        }
		...
		private void AudiometerPanel_Load(object sender, System.EventArgs e)
		{
