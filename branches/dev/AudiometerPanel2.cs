...
{
    /// <summary>
    /// Summary description for AudiometerPanel2.
    /// </summary>
    public class AudiometerPanel2 : System.Windows.Forms.Panel
    {
        /// <summary>
        ...
        /// <summary>
        /// All the fields created on the AudiometerPanel2 form
        /// </summary>
        ...
        /// <summary>
        /// AudiometerPanel2Controls is a structure designed to make keeping track of test parameters easier
        /// It also will be accessed by the mdi parent
        /// </summary>
        public struct AudiometerPanel2Settings
        {
        ...
        public AudiometerPanel2Settings ameterSettings = new AudiometerPanel2Settings();
        public channelSettings Channel1 = new channelSettings();
        public channelSettings Channel2 = new channelSettings();

        // delegates used for feedback to AudiometerPanel2
        ...
        /// <summary>
        /// The constructor of the AudiometerPanel2 class
        /// </summary>
        /// <param name="_presDel">The delegate function to be called when the presentation bar is pressed</param>
        /// <param name="_stChDel">The delegate function to be called when the AudiometerPanel2 state changes</param>
        public AudiometerPanel2(presentationDelegate _presDel, stateChangedDelegate _stChDel)
        {
            //
            ...
            // to include default settings of AudiometerPanel2 used in audiology
            // clinic. Notebook page 12.

            // General AudiometerPanel2 default settings
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(AudiometerPanel2));
            ...
            this.MinimumSize = new System.Drawing.Size(669, 479);
            this.Name = "AudiometerPanel2";
            //this.StartPosition = System.Windows.Forms.FormStartPosition.Manual;
            this.Text = "AudiometerPanel2";
            //this.Load += new System.EventHandler(this.AudiometerPanel2_Load);
                ...
                case TransducerType.Bone:
                    switch (ameterSettings.frequency)
                    {
                        ...
                        case 1000:
                            ...
                            else if (currVol > 75) // etc. See Max_AudiometerPanel2_Output spreadsheet
                            {
                                currVol = 75;
                                return true;
                            }
        ...
        private void AudiometerPanel2_Load(object sender, System.EventArgs e)
        {
        ...
        public VirtualLabToplevel MdiParent { get; set; }
    }
