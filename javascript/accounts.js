function register_valid(element) 
{
	...
	xmlhttp3.onreadystatechange = function()
	{
		if (xmlhttp3.readyState == 4 && xmlhttp3.status == 200) {
			/*error message but could be made prettier im sure you guys can figure it out*/
			document.getElementById("SubmitResponse").innerHTML = xmlhttp3.responseText;
		}
	}

	xmlhttp3.open("GET", "../php/register.php?q="+str, true);
	xmlhttp3.send();
