...
//var responseLeftColor = "rgb(0, 0, 255)";
//var responseRightColor = "rgb(255, 0, 0)";
var responseLeftColor = "rgb(41, 128, 185)";
var responseRightColor = "rgb(192, 57, 43)";
/*var responseLeftColor = "rgb(0, 147, 207)";
var responseRightColor = "rgb(205, 92, 92)";*/
var colorResetWait = 1000;

// Display patient response left (blue)
...
// Display patient response right (red)
...
function FreqMinus() {
    ...
    console.log("Frequency decsareased from " + oldFreq + "Hz to " + String(Freq) + "Hz");
    return Freq;
}
...
//var blueButtonColor = "rgb(0, 0, 255)";

var redButtonColor = "rgb(231, 76, 60)";
var blueButtonColor = "rgb(52, 152, 219)";
...
function changeColor(clicked_id) {
    ...
    if (tmp.style.backgroundColor == redButtonColor) {
        ...
        tmp.style.borderColor = redButtonColor;
...
function changeColorBlue(clicked_id) {
    ...
    if (tmp.style.backgroundColor == blueButtonColor) {
        ...
        tmp.style.borderColor = blueButtonColor;
        tmp.style.color = "white";
    }
...
var changeColorDelay = 1000;
function changeButtonColor(clicked_id) {
    var tmp = document.getElementById(clicked_id);
    if (clicked_id == 'Present1') {
        tmp.style.backgroundColor = blueButtonColor;
        tmp.style.borderColor = blueButtonColor;
        tmp.style.color = "white";
    }
    else if (clicked_id == 'Present2') {
        tmp.style.backgroundColor = redButtonColor;
        tmp.style.borderColor = redButtonColor;
        tmp.style.color = "white";
    }
...
function increaseDB(range){
    document.getElementById(range).stepUp(1);
    if (range == 'range1') {
        document.getElementById('dB1').innerHTML = document.getElementById(range).value + " dB HL";
        console.log("Range 1 up");
    }
    else if (range == 'range2') {
        document.getElementById('dB2').innerHTML = document.getElementById(range).value + " dB HL";
        console.log("Range 1 up");
    }
}
function decreaseDB(range){
    document.getElementById(range).stepDown(1);
    if (range == 'range1') {
        document.getElementById('dB1').innerHTML = document.getElementById(range).value + " dB HL";
        console.log("Range 1 down");
    }
    else if (range == 'range2') {
        document.getElementById('dB2').innerHTML = document.getElementById(range).value + " dB HL";
        console.log("Range 2 down");
    }
}
